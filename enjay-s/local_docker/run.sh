...
function run_tso() {
    ...
    --cpus 2 \
    --memory 500m \
    --mount type=bind,source="$(pwd)"/byconity/config,target=/etc/byconity/config \
    --mount type=bind,source="$(pwd)"/byconity/logs,target=/data/byconity/logs \
    --expose 18290 \
    --network host \
...
function run_dm() {
    ...
    --mount type=bind,source="$(pwd)"/byconity/config,target=/etc/byconity/config \
    --mount type=bind,source="$(pwd)"/byconity/logs,target=/data/byconity/logs \
    --mount type=bind,source="$(pwd)"/byconity/data/dm,target=/data/byconity/data \
    --expose 18390 \
    --expose 18391 \
    --network host \
...
function run_rm() {
    ...
    --mount type=bind,source="$(pwd)"/byconity/config,target=/etc/byconity/config \
    --mount type=bind,source="$(pwd)"/byconity/logs,target=/data/byconity/logs \
    --mount type=bind,source="$(pwd)"/byconity/data/rm,target=/data/byconity/data \
    --expose 18490 \
    --network host \
...
function run_server() {
    ...
    --mount type=bind,source="$(pwd)"/byconity/config,target=/etc/byconity/config \
    --mount type=bind,source="$(pwd)"/byconity/logs,target=/data/byconity/logs \
    --mount type=bind,source="$(pwd)"/byconity/data/server,target=/data/byconity/data \
    --expose 18590 \
    --expose 18591 \
    --expose 18592 \
    --expose 18593 \
...
function run_read_worker() {
    ...
    --mount type=bind,source="$(pwd)"/byconity/config,target=/etc/byconity/config \
    --mount type=bind,source="$(pwd)"/byconity/logs,target=/data/byconity/logs \
    --mount type=bind,source="$(pwd)"/byconity/data/worker,target=/data/byconity/data \
...
function run_write_worker() {
    ...
    --mount type=bind,source="$(pwd)"/byconity/config,target=/etc/byconity/config \
    --mount type=bind,source="$(pwd)"/byconity/logs,target=/data/byconity/logs \
    --mount type=bind,source="$(pwd)"/byconity/data/worker-writer,target=/data/byconity/data \
